#!/usr/bin/python
# SRC = https://github.com/ch4meleon/vba_obfuscator/blob/master/obfuscator.py
...
if len(sys.argv) <> 3:
    print "Usage: python vba_obfuscator.py inFile.vba outFile.vba"
    sys.exit()
